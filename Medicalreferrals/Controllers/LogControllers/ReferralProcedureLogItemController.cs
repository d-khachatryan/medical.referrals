...
namespace Medicalreferrals.Controllers
{
    ...
    public class ReferralProcedureLogItemController : Controller
    {
        // GET: ReferralProcedureLogItem
        ...
        public ActionResult ReadReferralProcedureLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<ReferralProcedureLogItem> items = from p in db.ReferralProcedureLogItems select p;
