...
namespace Medicalreferrals.Controllers
{
    ...
    public class ReferralSocialDiseaseLogItemController : Controller
    {
        // GET: ReferralSocialDiseaseLogItem
        ...
        public ActionResult ReadReferralSocialDiseaseLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<ReferralSocialDiseaseLogItem> items = from p in db.ReferralSocialDiseaseLogItems select p;
