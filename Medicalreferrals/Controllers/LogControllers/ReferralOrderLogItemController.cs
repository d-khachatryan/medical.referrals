...
namespace Medicalreferrals.Controllers
{
    ...
    public class ReferralOrderLogItemController : Controller
    {
        // GET: ReferralOrderLogItem
        ...
        public ActionResult ReadReferralOrderLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<ReferralOrderLogItem> items = from p in db.ReferralOrderLogItems select p;
