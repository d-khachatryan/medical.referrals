...
namespace Medicalreferrals.Controllers
{
    ...
    public class ReferralServiceLogItemController : Controller
    {
        // GET: ReferralServiceLogItem
        ...
        public ActionResult ReadReferralServiceLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<ReferralServiceLogItem> items = from p in db.ReferralServiceLogItems select p;
