...
namespace Medicalreferrals.Controllers
{
    ...
    public class InvocationDocumentLogItemController : Controller
    {
        ...
        public ActionResult ReadInvocationDocumentLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<InvocationDocumentLogItem> items = from p in db.InvocationDocumentLogItems select p;
