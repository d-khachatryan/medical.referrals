...
namespace Medicalreferrals.Controllers
{
    ...
    public class ReferralSurgeryLogItemController : Controller
    {
        // GET: ReferralSurgeryLogItem
        ...
        public ActionResult ReadReferralSurgeryLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<ReferralSurgeryLogItem> items = from p in db.ReferralSurgeryLogItems select p;
