...
namespace Medicalreferrals.Controllers
{
    ...
    public class InvocationLogItemController : Controller
    {
        // GET: InvocationLogItem
        ...
        public ActionResult ReadInvocationLogItems([DataSourceRequest]DataSourceRequest request, string userId, string startDate, string endDate)
        {
            using (var db = new StoreContext())
            {
                IQueryable<InvocationLogItem> items = from p in db.InvocationLogItems select p;
